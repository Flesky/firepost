<template>
  ...
  >
    ...
    <div class="text-white  w-2/3">
      <div class="text-4xl font-bold">Reconnect</div>
      <div class="text-lg mt-3">Keep in touch with your friends and the world around you.</div>
    </div>
  </div>
</template>
